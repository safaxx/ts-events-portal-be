...
public class EventRequest {
        ...
        // @Length(max = 2000, message = "Long description cannot exceed 2000
        // characters")
        ...
        @Pattern(regexp = "online|in-person", flags = Pattern.Flag.CASE_INSENSITIVE, message = "Event type must be 'online' or 'in-person'")
